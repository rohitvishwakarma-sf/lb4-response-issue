...
values
  ('Admin', '{CreateTodo,UpdateTodo,DeleteTodo,CreateMeetingSession,GenerateMeetingToken,StartMeetingArchive,StopMeetingArchive,GetMeetingArchives,DeleteMeetingArchive,StopMeeting,SetMeetingUploadTarget,GetMeetingAttendees,EditMeeting}', 0);
